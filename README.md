...
2 - No caso do Next.js, este arquivo deve ser colocado na pasta public e adicionado via meta tag na página \_document.js.

3 - Criar/Configurar um Service Worker (JavaScript)
...
Publicação em servidor com suporte à HTTPS
